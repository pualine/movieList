    ...
    return (
        <div className="flex-shrink-0 mr-4" style={{ width: "200px", height: "300px" }}>
            <div className="bg-gray-800 rounded-lg shadow-lg p-2 flex flex-col justify-between h-full text-left">
                <img src={`https://image.tmdb.org/t/p/w500/${movie.poster_path}`} alt={movie.title} className="w-full h-auto rounded-t-md object-cover object-center" style={{ height: "70%" }} />
                <div className="movie-info mt-2">
                    <h2 className="text-lg font-semibold text-gray-300 truncate">{movie.title}</h2>
